...
class ClassifyFst(GraphFst):
    ...
    Args:
        ...
        class_weights: The weight to be applied to each of the semiotic class,
            ...
            'cardinal': 1.1, 'ordinal': 1.1, 'decimal': 1.08, 'measure': 1.1, 'date': 1.09,
            'word': 100,'time': 1.05,'money': 1.07,'electronic': 1.1,'telephone': 1.1, 'whitelist': 1.01,
            'fraction': 1.09
    """
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            classify = (
                ...
                | pynutil.add_weight(class_graphs['fraction'], class_weights['fraction'])
